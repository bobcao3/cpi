...
export const projectCommand = defineCommand({
  ...
  subCommands: {
    ...
    create: defineCommand({
      meta: {
        name: "create",
        description: "Create a new project (with default columns + topics)",
      },
      args: {
        name: {
          type: "positional",
        ...
        skipDefaults: {
          type: "boolean",
          description: "Skip seeding default columns and topics",
        },
      },
      run({ args }) {
        ...
        const project = guard(() =>
          createProject(name, description, { applyDefaults }),
        );
    ...
    "add-defaults": defineCommand({
      meta: {
        name: "add-defaults",
        description: "Seed sensible default columns and topics",
      },
      args: {
        project: {
          type: "positional",
